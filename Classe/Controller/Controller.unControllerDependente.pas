...
begin
  ...
  Result.Clear;
  if ((not Assigned(AFuncionario)) or (AFuncionario.Id = 0)) then
    Exit;
  Result := TObjectList<TDependente>(TDAOGenerico<TDependente>.New.ObterListaComFiltro('ID_FUNCIONARIO', AFuncionario.Id));
end;
