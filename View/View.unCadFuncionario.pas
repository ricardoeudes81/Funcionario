...
uses
  ...
  Vcl.Controls, Vcl.Forms, Vcl.Dialogs, Vcl.StdCtrls, System.UITypes, Entidade.Funcionario, Controller.unControllerFuncionario,
  Vcl.ExtCtrls, Data.DB, Vcl.Buttons, Vcl.Grids, Vcl.DBGrids, View.unCadDependente,
  Datasnap.DBClient, Entidade.Dependente, Controller.unControllerDependente, System.Generics.Collections,
  Vcl.Mask, Helper.unMaskEditHelper, Utils.unUtils, View.unPesquisa, CalculaImpostos.unCalculaImpostos;
...
type
  ...
  private
    ...
    procedure ChecarCampoCPF;
    procedure ChecarCampoNome;
    procedure ChecarCampoSalario;
...
procedure TfrmCadFuncionario.ChecarCampoNome();
begin
  if (Trim(edtNome.Text) = EmptyStr) then
  begin
...
procedure TfrmCadFuncionario.ChecarCampoCPF();
begin
...
procedure TfrmCadFuncionario.ChecarCampoSalario();
begin
  if ((Trim(edtSalario.Text) = EmptyStr) or (Trim(edtSalario.Text) = VALOR_ZERO)) then
  begin
