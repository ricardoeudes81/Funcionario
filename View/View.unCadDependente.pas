unit View.unCadDependente;

interface

uses
  Winapi.Windows, Winapi.Messages, System.SysUtils, System.Variants, System.Classes, Vcl.Graphics,
  Vcl.Controls, Vcl.Forms, Vcl.Dialogs, Vcl.StdCtrls, Vcl.ExtCtrls, Vcl.Buttons, Entidade.Dependente;
...
begin
  ...
  FDependente.CalculaIR := Integer(chkCalculaIR.Checked);
  FDependente.CalculaINSS := Integer(chkCalculaINSS.Checked);
  Close;
...
begin
  ...
  begin
    ...
    chkCalculaIR.Checked := Boolean(Dependente.CalculaIR);
    chkCalculaINSS.Checked := Boolean(Dependente.CalculaINSS);
  end;
end;
